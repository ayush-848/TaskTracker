...
import { Home, Bell, User, LogOut, Check } from 'lucide-react';
...
const Layout = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gray-300 dark:bg-gray-950 relative">
      ...
      {/* Vertical Navigation */}
      <div
        className={`fixed inset-y-0 left-0 z-40 w-64 transform transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]
