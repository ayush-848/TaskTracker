    ...
    <div>
      {completedTasks.length === 0 ? (
        <div className="text-center py-12 rounded-lg bg-white dark:bg-gray-800 shadow-sm border border-gray-400 dark:border-gray-700">
          <p className="text-gray-600 dark:text-gray-300">You haven't completed any task.</p>
        </div>
      ) : (
          ...
          {completedTasks.map((task) => (
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div>
                  <Link to={`/user/tasks/${task._id}`} className="hover:text-indigo-400 transition-colors">
              ...
              <p className="text-gray-700 dark:text-gray-300 text-sm mb-6">{truncate(task.description)}</p>
