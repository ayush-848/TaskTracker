...
const SignUp = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      console.log("Registration successful:", response.data);} catch (error) {
  ...
  return (
    <section className="flex items-center justify-center min-h-screen bg-white dark:bg-gray-900">
      <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-md p-6 space-y-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <button type="submit" className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white bg-blue-500 rounded-lg hover:bg-blue-400 focus:ring focus:ring-blue-300">
          Sign Up
        </button>
